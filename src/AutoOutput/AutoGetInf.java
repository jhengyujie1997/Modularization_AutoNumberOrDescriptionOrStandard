...
public class AutoGetInf {
	 ...
	 */
	public static String getObjectValue(IItem item, LogNew logger, IAgileSession admin, String[] configs)
			throws APIException {
		...
		logger.log(2, "開始取得 Table：" + table.getName() + " 的資訊...");
		if (table.size() == 0) {
	...
	public static String getcolunmValue(IItem item, LogNew logger, IAgileSession admin, String colunm_APIName, String page,
		...
		logger.log(2, "開始取得" + cell.getName() + " 的值...");
	...
	public static String getListValue(IItem item, LogNew logger, IAgileSession admin, String colunm_APIName, String page,
		...
		logger.log(2, "開始取得" + cell.getName() + " 的清單...");
